    ...
    toast.custom(
      (t) => (
        <div
          ...
          } max-w-sm w-full bg-white shadow-2xl rounded-xl flex items-center gap-3 p-4 border border-gray-200`}
        >
          <Image
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-500">৳ {item.discountedPrice}</p>
            <Link
              href="/cart"
              className="inline-block mt-2 text-xs font-medium bg-blue text-white px-3 py-1 rounded-lg hover:bg-blue-dark transition"
    ...
    toast.custom(
      (t) => (
        <div
          className={`${
            t.visible ? "animate-enter" : "animate-leave"
          } max-w-sm w-full bg-pink-50 shadow-lg rounded-xl flex items-center gap-3 p-4 border border-pink-200`}
        >
    ...
    <div className="group">
      ...
      <div className="relative overflow-hidden flex items-center justify-center rounded-lg bg-[#F6F7FB] min-h-[270px] mb-4">
        ...
        <div className="absolute left-0 bottom-0 translate-y-full w-full flex items-center justify-center gap-2.5 pb-5 ease-linear duration-200 group-hover:translate-y-0">
          ...
          <button
            onClick={handleAddToCart}
            className="inline-flex font-medium text-custom-sm py-[7px] px-5 rounded-[5px] bg-blue text-white hover:bg-blue-dark ease-out duration-200"
          >
            Add to cart
          </button>
          ...
          <button
            ...
            className="flex items-center justify-center w-9 h-9 rounded-[5px] shadow-1 text-dark bg-white hover:text-pink-500 ease-out duration-200"
          >
            ❤️
          </button>
        </div>
      ...
      {/* Title */}
      <h3
        className="font-medium text-dark hover:text-blue mb-1.5 ease-out duration-200"
        onClick={handleProductDetails}
      >
        <Link href="/shop-details">{item.title}</Link>
      </h3>
