      ...
      <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
        <div className="relative overflow-hidden z-1 rounded-lg bg-[#D0E9F3] p-4 sm:p-7.5 lg:p-10 xl:p-15">
          <div className="max-w-[422px] w-full">
            ...
            <h2 className="font-bold text-dark text-xl lg:text-heading-4 xl:text-heading-3 mb-3">
              Mega Digital Bundle – Only 99 BDT!
            </h2>

            <p>
              Get 1,50,000+ premium digital resources including graphics, templates,
              fonts, software, and courses – everything you need in one bundle.
            </p>
          ...
          <Image
            //  src="/images/countdown/countdown-01.png"
            src="/images/countdown/mega-offer.png"
            alt="product"
            className="hidden lg:block absolute right-4 xl:right-33 bottom-4 xl:bottom-10 -z-1"
            width={611}
            height={576}
